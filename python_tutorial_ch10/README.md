...
本包是第10章《Python 办公自动化》的 Markdown 教材交付。

## 内容

- `chapters/`：教材正文
- `assets/ch10/`：本章正式图片，全部本地化、居中显示、图注在图下
- `assets/ch10/web/`：互联网原图、本机 PowerShell 截图和脚本生成的报告、作品集、展示墙、结课交付档案、交付包目录清单、最终运行证据预览图
- `code/ch10/`：可运行示例代码
- `input/`：脚本生成的 CSV 原料
- `reports/`：脚本生成的 Markdown、Word、Excel、PPT、课程作品集、结课展示墙、交付回执、交付包目录清单和预览图
...
科研卡片工厂结课报告：从 CSV 数据出发，自动生成 Markdown、Word、Excel、PPT、预览图、交付索引、全书课程作品集、结课展示墙、结课交付档案、交付回执、zip 交付包、交付包目录清单和最终运行证据，理解办公自动化的“输入、处理、输出、检查、汇总、展示、打包、复核、验收”闭环。
