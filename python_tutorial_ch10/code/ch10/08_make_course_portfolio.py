...
def draw_preview(rows: list[dict[str, str | int]]) -> None:
    ...
    draw.text((137, 185), "ch0-ch10 课程作品集交付总览", fill="#5F6673", font=subtitle_font)
    ...
    draw.text((365, 1008), "Generated by code/ch10/08_make_course_portfolio.py", fill="#8A5A00", font=small_font)
