...
VISUALS = ['ch05_cover.png', 'ch05_story_scene.png', 'ch05_roadmap.png', 'ch05_core_metaphor.png', 'ch05_minimal_demo.png', 'ch05_psychology_link.png', 'ch05_pitfall_map.png', 'ch05_project_dashboard.png']
...
def object_theater_story():
    im, d = canvas()
    shadow(d, (130, 100, 1670, 1010), radius=34)
    rounded(d, (130, 100, 1670, 1010), fill="#FFFFFF", radius=34)

    d.rectangle((170, 805, 1630, 900), fill="#E9EEF6")
    d.polygon([(170, 900), (1630, 900), (1530, 990), (270, 990)], fill="#D8E0EC")
    d.arc((210, 120, 1590, 740), start=0, end=180, fill="#CBD5E1", width=10)
    d.line((280, 180, 280, 790), fill="#CBD5E1", width=8)
    d.line((1520, 180, 1520, 790), fill="#CBD5E1", width=8)

    positions = [
        (420, 610, icon_card, BLUE),
        (720, 430, icon_package, GREEN),
        (1030, 430, icon_window, ORANGE),
        (1340, 610, icon_chart, PURPLE),
        (880, 720, icon_file, CYAN),
    ]
    for x1, y1, _, _ in positions:
        for x2, y2, _, _ in positions:
            if (x1, y1) < (x2, y2):
                d.line((x1, y1, x2, y2), fill="#E2E8F0", width=4)
    for x, y, icon, color in positions:
        shadow(d, (x - 112, y - 112, x + 112, y + 112), radius=30)
        rounded(d, (x - 112, y - 112, x + 112, y + 112), fill="#FFFFFF", outline=color, radius=30, width=6)
        icon(d, x, y, color)
        d.ellipse((x - 16, y + 122, x + 16, y + 154), fill=color)

    for start, end, color in [
        ((515, 560), (625, 470), BLUE),
        ((815, 430), (935, 430), GREEN),
        ((1135, 475), (1260, 560), ORANGE),
        ((1235, 665), (985, 720), PURPLE),
        ((780, 720), (510, 665), CYAN),
    ]:
        arrow(d, start, end, color=color, width=7)
    save(im, "ch05_object_theater_story.png")
