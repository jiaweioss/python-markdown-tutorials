"""Generate a reusable object result package for chapter 05."""
...
def draw_preview(package: dict) -> None:
    ...
    d.text((150, 125), "对象成果包", fill="#162033", font=font(50, True))
    ...
    d.text((330, 722), "JSON：对象、卡组和练习记录都已写入", fill="#8A5A00", font=font(25, True))

    d.rounded_rectangle((250, 790, 1250, 845), radius=20, fill="#F8FAFC", outline="#D8E0EC", width=2)
    d.text((405, 805), "复盘记录：类的职责、协作和保存结果", fill="#465263", font=font(22))
