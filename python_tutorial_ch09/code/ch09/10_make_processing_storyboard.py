...
def make_steps(source: Image.Image) -> list[tuple[str, Image.Image, str]]:
    ...
    card_draw.text((55, 362), "ready", fill=GREEN, font=font(18, True))
    return [
...
def write_storyboard(source: Image.Image) -> None:
    ...
    draw.text((100, 78), "Image Pipeline Storyboard", fill=INK, font=font(56, True))
    draw.text((100, 146), "One photo becomes a card-ready asset through visible, reversible steps.", fill=MUTED, font=font(25))
    ...
    draw.text((700, 736), "source -> card asset", fill=INK, font=font(23, True))
    draw.text((610, 885), "Generated by code/ch09/10_make_processing_storyboard.py", fill=MUTED, font=font(20))
