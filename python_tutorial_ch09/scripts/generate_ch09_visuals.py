...
VISUALS = ['ch09_cover.png', 'ch09_story_scene.png', 'ch09_roadmap.png', 'ch09_core_metaphor.png', 'ch09_minimal_demo.png', 'ch09_psychology_link.png', 'ch09_pitfall_map.png', 'ch09_project_dashboard.png']
...
def main():
    ...
    photo_plate("ch09_checker_shadow_illusion_story.png", "checker_shadow_illusion.jpg")
    photo_plate("ch09_before_after_result.png", "fronalpstock_before_after.png")
    photo_plate("ch09_powershell_image_run.png", "powershell_ch09_image_processing_run.png")
    photo_plate("ch09_image_runtime_evidence.png", "ch09_image_runtime_evidence.png")
    photo_plate("ch09_image_processing_report_preview.png", "ch09_image_processing_report_preview.png")
    photo_plate("ch09_visual_perception_lab.png", "ch09_visual_perception_lab.png")
    photo_plate("ch09_image_quality_contact_sheet.png", "ch09_image_quality_contact_sheet.png")
