...
| 需求 | 当前证据 | 状态 |
| --- | --- | --- |
| 符合 ch0/ch1 图文标准 | 正文约 20182 字，包含 `[TOC]`、本章导读、五个大部分、摄影史、数字图像史、Edwin Land、图像处理人文脉络图、真实风景图、NASA 科学图像、Helmholtz、Adelson 棋盘阴影错觉、处理前后对比、视觉感知实验、图像质量总览、处理故事板、视觉证据档案、运行证据总览、ch8 图像素材入库体检、PowerShell 运行图、代码、项目、练习与总结 | 已完成 |
