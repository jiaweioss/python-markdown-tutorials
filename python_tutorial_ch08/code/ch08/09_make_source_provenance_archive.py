...
def draw_preview(rows: list[dict[str, str | int]]) -> None:
    ...
    draw.text((140, 120), "Source Provenance Archive", fill="#162033", font=title_font)
    draw.text((142, 185), "Links become traceable evidence, not loose bookmarks.", fill="#64748B", font=subtitle_font)
    ...
    draw.text((440, 908), "Generated by code/ch08/09_make_source_provenance_archive.py", fill="#1D4ED8", font=small_font)
