...
VISUALS = ['ch08_cover.png', 'ch08_story_scene.png', 'ch08_roadmap.png', 'ch08_core_metaphor.png', 'ch08_minimal_demo.png', 'ch08_psychology_link.png', 'ch08_pitfall_map.png', 'ch08_project_dashboard.png']
...
def main():
    for i, name in enumerate(VISUALS):
        visual(name, i)
    photo_plate("ch08_tim_berners_lee_office_story.png", "tim_berners_lee_office_cern.jpg")
    photo_plate("ch08_tim_berners_lee_portrait_story.png", "tim_berners_lee_portrait.jpg")
    photo_plate("ch08_vannevar_bush_story.png", "vannevar_bush_1938.jpg")
    photo_plate("ch08_worldwideweb_browser_story.png", "worldwideweb_browser.png")
    photo_plate("ch08_mosaic_browser_story.png", "ncsa_mosaic_browser_screenshot.png")
    photo_plate("ch08_first_web_server_story.png", "cern_first_web_server.jpg")
