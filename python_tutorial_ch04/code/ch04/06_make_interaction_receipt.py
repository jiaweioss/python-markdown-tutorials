...
def draw_receipt() -> None:
    ...
    d.text((150, 125), "GUI 交互回执", fill="#162033", font=font(52, True))
    d.text((152, 200), "检查 Tkinter 卡片面板后生成的交互证据。", fill="#5F6673", font=font(27))
    ...
    d.text((605, 305), "证据", fill="#166534", font=font(27, True))
    ...
    d.text((335, 826), "报告：reports/ch04_interaction_receipt.md", fill="#465263", font=font(20))
